...
* [Introduction](ug998.md#introduction)
  * [Programming Model](ug998.md#programming-model)
* [FPGA Architecture](ug998.md#fpga-architecture)
  * [Look Up Table (LUT)](ug998.md#look-up-table-lut)
  * [Flip-Flop](ug998.md#flip-flop)
  * [DSP Block](ug998.md#dsp-block)
  * [Storage Elements](ug998.md#storage-elements)
    * [BRAM](ug998.md#bram)
    * [URAM](ug998.md#uram)
    * [LUT](ug998.md#lut)
    * [Shift Register](ug998.md#shift-register)
* [FPGA Parallelism Versus Processor Architectures](ug998.md#fpga-parallelism-versus-processor-architectures)
  * [Program Execution on a Processor](ug998.md#program-execution-on-a-processor)
  * [Program Execution on an FPGA](ug998.md#program-execution-on-an-fpga)
    * [Scheduling](ug998.md#scheduling)
    * [Pipelining](ug998.md#pipelining)
    * [Dataflow](ug998.md#dataflow)
* [Basic Concepts of Hardware Design](ug998.md#basic-concepts-of-hardware-design)
  * [Clock Frequency](ug998.md#clock-frequency)
    * [Instruction execution](ug998.md#instruction-execution)
    * [Power Consumption](ug998.md#power-consumption)
  * [Latency and Pipelining](ug998.md#latency-and-pipelining)
    * [Important points](ug998.md#important-points)
  * [Throughput](ug998.md#throughput)
  * [Memory Architecture and Layout](ug998.md#memory-architecture-and-layout)
    * [Registers](ug998.md#registers)
    * [Shift Register](ug998.md#shift-register-1)
    * [FIFO](ug998.md#fifo)
    * [BRAM](ug998.md#bram-1)
* [Vivado High-Level Synthesis](ug998.md#vivado-high-level-synthesis)
  * [Operations](ug998.md#operations)
    * [Tradeoff between resources, performance, and application](ug998.md#tradeoff-between-resources-performance-and-application)
    * [Optimizations by vivado HLS](ug998.md#optimizations-by-vivado-hls)
  * [Conditional Statements](ug998.md#conditional-statements)
  * [Loops](ug998.md#loops)
    * [Optimizations by vivado HLS](ug998.md#optimizations-by-vivado-hls-1)
  * [Functions](ug998.md#functions)
  * [Dynamic Memory Allocation](ug998.md#dynamic-memory-allocation)
    * [HLS-Compliant Automatic Memory Allocation](ug998.md#hls-compliant-automatic-memory-allocation)
    * [HLS-Compliant Static Memory Allocation](ug998.md#hls-compliant-static-memory-allocation)
  * [Pointers](ug998.md#pointers)
* [Software Verification and Vivado HLS](ug998.md#software-verification-and-vivado-hls)
  * [Software Test Bench](ug998.md#software-test-bench)
    * [Segmentation faults](ug998.md#segmentation-faults)
  * [Code Coverage](ug998.md#code-coverage)
  * [Uninitialized Variables](ug998.md#uninitialized-variables)
  * [Out-of-Bounds Memory Access](ug998.md#out-of-bounds-memory-access)
  * [Co-Simulation](ug998.md#co-simulation)
  * [When C/C++ Verification Is Not Possible](ug998.md#when-cc-verification-is-not-possible)
* [Design Example: Application Running on a Zynq-7000 SoC](ug998.md#design-example-application-running-on-a-zynq-7000-soc)
  * [Analyzing and partitioning the processor code](ug998.md#analyzing-and-partitioning-the-processor-code)
  * [Compiling the program in Vivado HLS](ug998.md#compiling-the-program-in-vivado-hls)
  * [Composing the system in Vivado IP integrator](ug998.md#composing-the-system-in-vivado-ip-integrator)
  * [Connecting processor code and FPGA fabric functions](ug998.md#connecting-processor-code-and-fpga-fabric-functions)
* [Verification of a Complete Application](ug998.md#verification-of-a-complete-application)
  * [Standalone compute systems](ug998.md#standalone-compute-systems)
    * [Module Verification](ug998.md#module-verification)
    * [Connectivity Verification](ug998.md#connectivity-verification)
    * [Application Verification](ug998.md#application-verification)
    * [Device Validation](ug998.md#device-validation)
  * [Processor-based systems](ug998.md#processor-based-systems)
    * [Hardware in the Loop (HIL) Verification](ug998.md#hardware-in-the-loop-hil-verification)
    * [Virtual Platform(VP) Verification](ug998.md#virtual-platformvp-verification)
    * [Device Validation](ug998.md#device-validation-1)
...
::: center ![Basic FPGA Architecture](../HLS/images/FPGAArch.png){#FPGAArch width="75%"} :::
...
::: center ![Contemporary FPGA
Architecture](../HLS/images/ContempFPGAArch.png){#ContempFPGAArch width="\textwidth"} :::
...
::: highlight Note: A typical value for N in Xilinx FPGA devices is 6. :::
...
::: center ![Functional Representation of a LUT as Collection of Memory
Cells](../HLS/images/LUT.png){#LUT width="60%"} :::
...
::: center ![Structure of a Flip-Flop](../HLS/images/flipflop.png){#flipflop width="40%"} :::
...
::: center ![Structure of a DSP Block](../HLS/images/dsp.png){#dsp width="\textwidth"} :::
...
::: highlight IMPORTANT: The level of effort required by the software engineer in restructuring algorithms to better fit the available processor cache is not required when the same operation is implemented in an FPGA. :::
...
::: highlight NOTE: As a general rule, 1 LUT is equivalent to 1 bit of computation. :::
...
::: center ![Processor with Multiple Instruction Execution
Units](../HLS/images/multiProcessor.png){#multiProcessor width="80%"} :::
...
::: center ![FPGA with Multiple Instruction Execution
Units](../HLS/images/multiFPGA.png){#multiFPGA width="60%"} :::
...
::: center ![FPGA Implementation without
Pipelining](../HLS/images/FPGAWOPipe.png){#FPGAWOPipe width="60%"} :::
...
::: center ![FPGA Implementation with
Pipelining](../HLS/images/FPGAwithPipe.png){#FPGAwithPipe width="80%"} :::

::: highlight **IMPORTANT: The latency caused by pipelining is one of the trade-offs to consider during FPGA design.** :::
...
::: highlight Note: The definition of throughput described in this section can also be used when analyzing applications executing on a processor. :::
...
::: highlight Although all of these techniques are portable across processors, the results are not. A software program must be tuned for each processor it runs on to maximize performance. :::
...
::: highlight IMPORTANT: Vivado HLS can compile almost any C/C++ program. The only coding limitation for Vivado HLS is with dynamic language constructs typical in processors with a single memory space. When using Vivado HLS, the main dynamic constructs to consider are memory allocation and pointers. :::
...
::: highlight Note: HLS cannot synthesize code that includes any of the dynamic memory allocation keywords even if the allocation is constant. :::
...
_In an HLS-generated implementation, it is difficult to detect a segmentation fault, because there is no processor and no operating system monitoring program execution._ The only indicator of a segmentation fault is the appearance of incorrect result values generated by the circuit.

::: highlight RECOMMENDED: When working with HLS, it is recommended that the designer ensure that the software test bench compiles and executes the function without issues on a processor. This guarantees that the HLS-generated implementation will not result in a segmentation fault. :::
...
::: highlight IMPORTANT: Errors must not be fixed directly in the generated RTL. Any issues with functional correctness are a direct result of the functional correctness of the software algorithm. :::

::: highlight TIP: The software test bench used to exercise an algorithm targeted for FPGA implementation with HLS does not have any coding style restrictions. The software engineer is free to use any valid C/C++ coding style or construct to thoroughly test the functional correctness of an algorithm. :::
...
::: highlight RECOMMENDED: Before using HLS to compile a software function for FPGA execution, it is recommended that all of the issues flagged by a dynamic code checker are resolved by the designer. :::
...
::: highlight It is also important to remember that the purpose of co-simulation is not to verify the functional correctness of an algorithm. Instead, the purpose is to check that the algorithm was not broken by user guidance to the HLS compiler. :::
...
::: highlight RECOMMENDED: When working with multiple projects or modules, it is recommended that the source code is separated into different files. This simple technique prevents issues with one module compilation affecting the other module in the design. :::
...
::: highlight IMPORTANT: It is important to remember that the purpose of this simulation is only to check connectivity and the proper flow of data through the system. The connectivity verification step does not verify the functional correctness of the application. :::
...
::: highlight IMPORTANT: It is important to remember that adding RTL modules impacts the runtime on the virtual platform and slows down execution. :::
