...
* [Design Principles for Software Programmers](ug1399.md#design-principles-for-software-programmers)
  * [Introduction](ug1399.md#introduction)
  * [Computer Architecture](ug1399.md#computer-architecture)
  * [Three Paradigms for Programming FPGAs](ug1399.md#three-paradigms-for-programming-fpgas)
    * [Producer-Consumer Paradigm](ug1399.md#producer-consumer-paradigm)
    * [Streaming Data Paradigm "Dataflow"](ug1399.md#streaming-data-paradigm-dataflow)
    * [Pipelining Paradigm](ug1399.md#pipelining-paradigm)
  * [Combining the Three Paradigms](ug1399.md#combining-the-three-paradigms)
  * [Conclusion - A Prescription for performance](ug1399.md#conclusion---a-prescription-for-performance)
* [Introduction to Vitis/Vivado HLS](ug1399.md#introduction-to-vitisvivado-hls)
  * [High-Level Synthesis Benefits](ug1399.md#high-level-synthesis-benefits)
  * [High-Level Synthesis Basics](ug1399.md#high-level-synthesis-basics)
* [Vitis/Vivado HLS Process Overview](ug1399.md#vitisvivado-hls-process-overview)
* [Creating project with Vitis HLS](ug1399.md#creating-project-with-vitis-hls)
  * [Coding C/C++ Functions](ug1399.md#coding-cc-functions)
    * [Coding Style](ug1399.md#coding-style)
    * [C/C++ Language Support](ug1399.md#cc-language-support)
    * [Libraries in Vitis HLS](ug1399.md#libraries-in-vitis-hls)
  * [Specifying the Clock Frequency](ug1399.md#specifying-the-clock-frequency)
* [C simulation verification](ug1399.md#c-simulation-verification)
  * [Writing a Test Bench](ug1399.md#writing-a-test-bench)
* [C Synthesis](ug1399.md#c-synthesis)
* [Analyzing the Results of Synthesis](ug1399.md#analyzing-the-results-of-synthesis)
  * [Schedule Viewer](ug1399.md#schedule-viewer)
  * [Function Call Graph Viewer](ug1399.md#function-call-graph-viewer)
  * [Dataflow Viewer](ug1399.md#dataflow-viewer)
* [Optimizing the HLS Project](ug1399.md#optimizing-the-hls-project)
  * [Creating Additional Solutions](ug1399.md#creating-additional-solutions)
  * [Adding Pragmas and Directives](ug1399.md#adding-pragmas-and-directives)
  * [Using Directives in Scripts vs Pragmas in Code](ug1399.md#using-directives-in-scripts-vs-pragmas-in-code)
    * [Directives file (Tcl Script)](ug1399.md#directives-file-tcl-script)
    * [Source Code (Pragma)](ug1399.md#source-code-pragma)
    * [Applying Directives to the Proper Scope](ug1399.md#applying-directives-to-the-proper-scope)
    * [Applying Optimization Directives to Global Variables](ug1399.md#applying-optimization-directives-to-global-variables)
    * [Applying Optimization Directives to Class Objects](ug1399.md#applying-optimization-directives-to-class-objects)
    * [Applying Optimization Directives to Templates](ug1399.md#applying-optimization-directives-to-templates)
* [C/RTL Co-Simulation in Vitis HLS](ug1399.md#crtl-co-simulation-in-vitis-hls)
  * [Automatically Verifying the RTL](ug1399.md#automatically-verifying-the-rtl)
    * [Verification of DATAFLOW and DEPENDENCE](ug1399.md#verification-of-dataflow-and-dependence)
    * [Unsupported Optimizations for Co-Simulation](ug1399.md#unsupported-optimizations-for-co-simulation)
  * [Analyzing RTL Simulations](ug1399.md#analyzing-rtl-simulations)
  * [Cosim Deadlock Viewer](ug1399.md#cosim-deadlock-viewer)
  * [Debugging C/RTL Co-Simulation](ug1399.md#debugging-crtl-co-simulation)
* [Exporting the RTL Design](ug1399.md#exporting-the-rtl-design)
* [Vitis HLS Command Line Interface](ug1399.md#vitis-hls-command-line-interface)
  * [Running Vitis HLS Interactively](ug1399.md#running-vitis-hls-interactively)
  * [Running Vitis HLS in Batch Mode](ug1399.md#running-vitis-hls-in-batch-mode)
* [Designing Efficient Kernels](ug1399.md#designing-efficient-kernels)
* [Vitis HLS Coding Styles](ug1399.md#vitis-hls-coding-styles)
  * [Unsupported C/C++ Constructs](ug1399.md#unsupported-cc-constructs)
    * [System Calls](ug1399.md#system-calls)
    * [Dynamic Memory Usage](ug1399.md#dynamic-memory-usage)
    * [Pointer Limitations](ug1399.md#pointer-limitations)
    * [Recursive Functions](ug1399.md#recursive-functions)
      * [Standard Template Libraries](ug1399.md#standard-template-libraries)
  * [Functions](ug1399.md#functions)
    * [Inlining Functions](ug1399.md#inlining-functions)
    * [C/C++ Builtin Functions](ug1399.md#cc-builtin-functions)
  * [Loops](ug1399.md#loops)
    * [Rolled implementation](ug1399.md#rolled-implementation)
    * [Full loop unroll](ug1399.md#full-loop-unroll)
    * [Partial loop unroll](ug1399.md#partial-loop-unroll)
    * [Loop Pipelining](ug1399.md#loop-pipelining)
    * [Nested Loop](ug1399.md#nested-loop)
    * [Loop flattening](ug1399.md#loop-flattening)
    * [Loop Merging](ug1399.md#loop-merging)
      * [Loop Merging Rules](ug1399.md#loop-merging-rules)
    * [Variable Loop Bounds](ug1399.md#variable-loop-bounds)
    * [Loop Parallelism](ug1399.md#loop-parallelism)
    * [Loop Dependencies](ug1399.md#loop-dependencies)
  * [Arrays](ug1399.md#arrays)
    * [Minimize the parallel array access](ug1399.md#minimize-the-parallel-array-access)
      * [Rewriting code to reduce memory access](ug1399.md#rewriting-code-to-reduce-memory-access)
    * [Array merging](ug1399.md#array-merging)
    * [Array partitioning](ug1399.md#array-partitioning)
* [Defining Interfaces](ug1399.md#defining-interfaces)
* [Optimization Techniques in Vitis HLS](ug1399.md#optimization-techniques-in-vitis-hls)
...
::: highlight This general purpose flexibility comes at a cost in terms of power and peak throughput. :::
...
A program written in C/C++ is essentially written for the von Neumann style of architecture where each instruction is executed sequentially. In order to achieve high performance, the HLS tool must infer parallelism in the sequential code and exploit it to achieve greater performance.
...
Similarly, in FPGAs, same fork/join type of parallelism is applied. A key pattern for throughput on FPGAs is the producer-consumer paradigm. The producerconsumer paradigm is applied to a sequential program and it is converted to extract functionality that can be executed in parallel to improve performance. The goal is to decompose the program in such a way that you can identify tasks that can potentially execute in parallel and therefore increase the throughput of the system.
...
Decomposing your algorithm into producerconsumer relationships that communicate by streaming data through the network has several advantages.
...
::: highlight Pipelining does not decrease the latency, that is, the total time for one item to go through the whole system. It does however increase the system's throughput, that is, the rate at which new items are processed after the first one. :::

* Delay associated with the number of clock cycles lost before the first valid output is delivered is referred to as _Iteration Latency_.
* _Initiation Interval (II)_ of the pipeline is defined as the time taken by the design between delivering two consecutive outputs post Iteration Latency or first output.
* The overall time taken to deliver all the outputs through iterations is referred to as the _Total Latency_ of the pipeline.

::: highlight Total Latency = Iteration Latency + II \* (iterations - 1) :::
...
::: highlight The three paradigms show how parallelism can be achieved in the design without needing the complexities of multi-threading and/or parallel programming languages. :::
...
::: center ![Vitis/Vivado HLS Design Flow](../HLS/images/VitisFlow.png){#VitisFlow width="70%"} :::
...
* In addition, the Vitis accelerated libraries are available for use with Vitis HLS, including common functions of math, statistics, linear algebra and DSP; and also supporting domain specific applications, like vision and image processing, quantitative finance, database, data analytics, and data compression. Documentation for the Vitis accelerated libraries can be found at [https://xilinx.github.io/Vitis\_Libraries/](https://xilinx.github.io/Vitis\_Libraries/)
...
* Optimization Directives, or the set\_directive commands, can be specified as Tcl commands that are associated with a specific solution, or set of solutions. Allowing you to customize the synthesis results for the same code base across different solutions.

::: highlight In cases where pragmas or directives conflict with other pragmas or directives, the synthesis process returns an error until the conflict is resolved. :::
...
::: highlight Directives that include a recursive option, such as the PIPELINE directive, can be applied recursively through the hierarchy. :::
...
::: center ![C/RTL Verification
Flow](../HLS/images/CRTLVerification.PNG){#CRTLVerification.PNG width="90%"} :::
...
* Top-level function must be synthesized using an ap\_ctrl\_chain or ap\_ctrl\_hs blocklevel protocol.
* Design must be purely combinational
* Top-level function must have an initiation interval of 1
* Interfaces must be all arrays that are streaming and implemented with axis or ap\_hs interface modes
...
In non-pipelined designs, C/RTL co-simulation measures latency between ap\_start and ap\_done signals. The II is 1 more than the latency, because the design reads new inputs 1 cycle after all operations are complete.
...
Vitis HLS defines the macro \_\_SYNTHESIS\_\_ when synthesis is performed. This allows the \_\_SYNTHESIS\_\_ macro to exclude non-synthesizable code from the design.

::: highlight Only the \_\_SYNTHESIS\_\_ macro should be used in the code to be synthesized. Macro in the test bench should not be used, as it is not obeyed by C/C++ simulation or C/C++ RTL co-simulation. :::

The \_\_SYNTHESIS\_\_ macro must not be defined or undefined in code or with compiler options, otherwise compilation might fail. The \_\_SYNTHESIS\_\_ macro is a convenient way to exclude non-synthesizable code without removing the code itself from the function, it can result in different results between C/C++ simulation and C/C++ synthesis.
...
::: highlight The top-level function cannot be a static function. :::
...
::: highlight Vitis HLS can perform automatic inlining of small functions. :::
...
* \_\_builtin\_clz(unsigned int x): Returns the number of leading 0-bits in x, starting at the most significant bit position. If x is 0, the result is undefined.
* \_\_builtin\_ctz(unsigned int x): Returns the number of trailing 0-bits in x, starting at the least significant bit position. If x is 0, the result is undefined.
...
::: highlight Avoid use of global variables for loop index variables, as this can inhibit some optimizations. :::
...
::: highlight There should not be any inter-iteration dependency, only then a full loop unroll can be achieved. :::
...
::: highlight As the loop is unrolled partially by a certain factor, the accesses/fetches from a memory are increased by the same factor. Hence, the array or memory must be split or partitioned. :::

Syntax: #pragma HLS UNROLL factor=8

::: center ![Loop roll, unroll and partially unroll](../HLS/images/LoopRoll.png){#LoopRoll width="\textwidth"} :::
...
::: center ![Loop pipelining](../HLS/images/LoopPipe.png){#LoopPipe width="\textwidth"} :::
...
: In a perfect loop, only the innermost loop has the loop body content. There is no logic specified between the loop statements. All the loop bounds are constant.

Semi-Perfect Loops

: In a semi-perfect loop, only the innermost loop has the loop body content. There is no logic specified between the loop statements. The outermost loop bound can be a variable.
...
All rolled loops imply and create at least one state in the design FSM. When there are multiple sequential loops, it can create additional unnecessary clock cycles and prevent further optimizations. The Vitis HLS tool provides the LOOP\_MERGE optimization directive, which can be used to automatically merge the loops. The LOOP\_MERGE directive will seek to merge all the loops within the scope it is placed.
...
* Another issue with variable loop bounds is that the performance of the design is unknown. There are two ways to overcome this issue:
  * Use the pragma HLS loop\_tripcount or set\_directive\_loop\_tripcount. The tripcount is the number of loop iterations. The tripcount directive allows a minimum and/or maximum tripcount to be specified for the loop.
...
* Syntax: #pragma HLS ARRAY\_MAP variable instance horizontal/vertical
...
* Syntax: #pragma HLS array\_partition variable=\<name> \<type> factor=\<int> dim=\<int>
  * Partition types:
...
::: center ![Array partitioning](../HLS/images/ArrayPart.png){#ArrayPart width="\textwidth"} :::
