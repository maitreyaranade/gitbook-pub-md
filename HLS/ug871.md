- [High-Level Synthesis Introduction](#high-level-synthesis-introduction)
  - [Lab 1: Creating a High-Level Synthesis Project](#lab-1-creating-a-high-level-synthesis-project)
    - [HLS Graphical User Interface (GUI)](#hls-graphical-user-interface-gui)
    - [Usual self check operation of test bench](#usual-self-check-operation-of-test-bench)
    - [C synthesis report](#c-synthesis-report)
    - [RTL co-simulation](#rtl-co-simulation)
  - [Lab 2: Using the Tcl Command Interface](#lab-2-using-the-tcl-command-interface)
    - [Important points to note](#important-points-to-note)
  - [Lab 3: Using Solutions for Design Optimization](#lab-3-using-solutions-for-design-optimization)
- [C Validation](#c-validation)
  - [Lab 1: C Validation and Debug](#lab-1-c-validation-and-debug)
    - [Good practices for writing a testbench](#good-practices-for-writing-a-testbench)
  - [Lab 2: C Validation with ANSI C Arbitrary Precision Types](#lab-2-c-validation-with-ansi-c-arbitrary-precision-types)
  - [Lab 3: C Validation with C++ Arbitrary Precision Types](#lab-3-c-validation-with-c-arbitrary-precision-types)
- [Interface synthesis](#interface-synthesis)
  - [Lab 1: Block-Level I/O Protocols](#lab-1-block-level-io-protocols)
    - [Important points to be noted](#important-points-to-be-noted)
    - [Block level I/O Protocol](#block-level-io-protocol)
    - [Types of the block-level interface protocol](#types-of-the-block-level-interface-protocol)
  - [Lab 2: Port I/O Protocols](#lab-2-port-io-protocols)
    - [Important points to be noted](#important-points-to-be-noted-1)
  - [Lab 3: Implementing Arrays as RTL Interfaces](#lab-3-implementing-arrays-as-rtl-interfaces)
    - [Important points to be noted](#important-points-to-be-noted-2)
  - [Lab 4: Implementing AXI4 Interfaces](#lab-4-implementing-axi4-interfaces)
- [Arbitrary Precision Types](#arbitrary-precision-types)
  - [Lab 1: Arbitrary Precision](#lab-1-arbitrary-precision)
  - [Lab 2: Arbitrary Precision](#lab-2-arbitrary-precision)
- [Design Analysis](#design-analysis)
  - [Lab 1: Design Optimization](#lab-1-design-optimization)
    - [Important points to be noted](#important-points-to-be-noted-3)
- [Design Optimization](#design-optimization)
  - [Lab 1: Optimizing a Matrix Multiplier](#lab-1-optimizing-a-matrix-multiplier)
    - [Aim](#aim)
  - [Lab 2: C Code Optimized for I/O Accesses](#lab-2-c-code-optimized-for-io-accesses)
- [RTL Verification](#rtl-verification)
  - [Lab 1: RTL Verification and the C Test Bench](#lab-1-rtl-verification-and-the-c-test-bench)
  - [Lab 2: Viewing Trace Files in Vivado](#lab-2-viewing-trace-files-in-vivado)
  - [Lab 3: Viewing Trace Files in ModelSim](#lab-3-viewing-trace-files-in-modelsim)
- [Using HLS IP in IP Integrator](#using-hls-ip-in-ip-integrator)
  - [Lab 1: Integrate HLS IP with a Xilinx IP Block](#lab-1-integrate-hls-ip-with-a-xilinx-ip-block)
- [Using HLS IP in a Zynq AP SoC Design](#using-hls-ip-in-a-zynq-ap-soc-design)
  - [Lab 1: Implement Vivado HLS IP on a Zynq Device](#lab-1-implement-vivado-hls-ip-on-a-zynq-device)
  - [Lab 2: Streaming Data Between the Zynq CPU and HLS Accelerator Blocks](#lab-2-streaming-data-between-the-zynq-cpu-and-hls-accelerator-blocks)
